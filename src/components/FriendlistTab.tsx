                  ...
                  >
                    <div className="mt-4 pt-4 border-t border-cyan-500/25 space-y-4">
                      ...
                      >
                        ...
                        <ul className="text-xs font-mono space-y-1.5 bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 p-3.5 rounded border border-slate-800 shadow-[inset_0_1px_3px_rgba(0,0,0,0.5)]">
                          {(language === 'en' ? friend.characteristics_en || friend.characteristics : friend.characteristics).map((ciri, index) => (
                            <li key={index} className="flex gap-2.5 items-start">
                              <span className={`font-bold mt-0.5 shrink-0 select-none ${
                                friend.type === 'sahabat' ? 'text-yellow-400' : friend.type === 'pacar' ? 'text-pink-400' : 'text-cyan-400'
                              }`}>-</span>
                              <span className="bg-gradient-to-r from-cyan-400 via-cyan-300 to-slate-400 bg-clip-text text-transparent font-medium leading-relaxed">
                                {ciri}
                              </span>
                            </li>
                          ))}
