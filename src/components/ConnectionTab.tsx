...
import { Github, MessageSquare, Instagram, Send, Twitter, Globe, Terminal, Activity, Wifi, ShieldAlert, CheckCircle, Zap, Music } from 'lucide-react';
...
export default function ConnectionTab() {
  ...
  const getIcon = (name: string) => {
    switch (name) {
      ...
      case 'Zap':
        return <Zap className="w-5 h-5 text-[#f97316] animate-pulse" />;
      case 'Music':
        return <Music className="w-5 h-5 text-[#25f4ee]" />;
      default:
